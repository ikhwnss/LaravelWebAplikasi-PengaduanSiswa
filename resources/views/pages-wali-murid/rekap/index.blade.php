                        ...
                        @foreach ($rekap as $item)
                            ...
                            <td>
                                @if ($item->tanggapan !== null)
                                    <a href="{{route('wali-murid.tanggapan.edit', ['id' => $item->id,
                                     'id_tanggapan' => $item->tanggapan->id])}}" class="btn btn-sm btn-success">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                @else
                                    <a href="{{route('wali-murid.tanggapan.tambah', ['id' => $item->id])}}" class="btn btn-sm btn-primary">
                            ...
                            <td>
                                <a href="{{route('wali-murid.rekap.detail', ['id' => $item->id])}}" class="btn btn-sm btn-success" title="Lihat Selengkapnya">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>
